                            ...
                            <form method="POST">
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary" style="margin-right:15px;" name="signin">Sign in</button>
                                             <u><a href="forgot.php" name="forgot_password" style="font-size:18px;">Forgot Password?</a></u>
                                        </div>
                                    </div>
                                    <div class="col-md-2"></div>
                                </div>
