...
<head>
                ...
                <div class="container-fluid border border-white">
                    <form class="needs-validation"  method="POST">
                        ...
                        <div class="col-md-6">
							...
							<input class="form-control" id="sname" style="margin: auto" name="sname" type="text" placeholder="Enter Subject" required>
                            </div>
					...
					<div class="row">
						...
						<div class="col-md-4">
								<button class="btn btn-primary" type="submit" name="submit" style="margin-top:40px;">Submit </button>
						</div>
						<div class="col-md-4"></div>
					</div>
    ...
    <script src="assets/js/admin-script.js"></script>
        ...
        $query = "INSERT INTO `subject`( `subject`, `branch`, `year`) VALUES('$_POST[sname]','$_POST[Branch]','$_POST[year]')";
